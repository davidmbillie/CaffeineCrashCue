...
namespace CaffeineCrashProvider.Sizes
{
    public class SizesCoffeehouse : SizesSet
    {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Medium = new Dictionary<string, Beverage>()
        {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Light = new Dictionary<string, Beverage>()
        {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Iced_Chai_Tea = new Dictionary<string, Beverage>()
        {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Green_Tea_Latte = new Dictionary<string, Beverage>()
        {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Coffee_Frappucino = new Dictionary<string, Beverage>()
        {
            {"Small", new Beverage(8, 70)},
        ...
        public static readonly ImmutableDictionary<string, Beverage> Espresso_Frappucino = new Dictionary<string, Beverage>()
        {
        ...
        public static readonly ImmutableDictionary<string, Beverage> Frappucino_Lite = new Dictionary<string, Beverage>()
        {
            {"Small", new Beverage(8, 70)},
            {"Medium", new Beverage(12, 95)},
        ...
        public static readonly ImmutableDictionary<string, Beverage> Green_Tea_Frappucino = new Dictionary<string, Beverage>()
        {
